...
</button>`;var p=(i=>(i.Change="change",i.Remove="remove",i))(p||{}),u=(o=>(o.Handle="handle",o.ColorLabel="color-label",o.Color="color",o.IsFinished="is-finished",o.Description="description",o.RemoveButton="remove-button",o.RemoveIcon="remove-icon",o))(u||{}),c=new CSSStyleSheet;c.replaceSync(l);var s="task-card",r=class extends HTMLElement{componentParts=new Map;getElement(e){if(this.componentParts.get(e)==null){let i=this.findElement(e);i!=null&&this.componentParts.set(e,i)}return this.componentParts.get(e)}findElement(e){return this.shadowRoot.getElementById(e)}get value(){return this.findElement("description").textContent}#t=null;constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=d,this.shadowRoot.adoptedStyleSheets.push(c),this.findElement("custom-check").addEventListener("slotchange",e=>{let i=e.target.assignedNodes()[0];this.classList.toggle("custom-checkbox",i!=null)}),this.findElement("color").addEventListener("change",e=>{this.dispatchEvent(new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0,detail:this.#e("color")}))}),this.findElement("is-finished").addEventListener("change",e=>{if(this.dispatchEvent(new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0,detail:this.#e("is-finished")}))==!1)return;let t=e.target.checked;this.classList.toggle("finished",t),this.part.toggle("finished",t);let n=this.findElement("finished-indicator");n.classList.toggle("finished",t),n.part.toggle("finished",t)}),this.findElement("description").addEventListener("blur",e=>{this.value!=this.#t&&this.dispatchEvent(new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0,detail:this.#e("description")})),this.#t=this.value}),this.findElement("remove-button").addEventListener("click",e=>{this.dispatchEvent(new CustomEvent("remove",{bubbles:!0,cancelable:!0,composed:!0}))}),this.#i()}#i(){let e=[...this.shadowRoot.querySelectorAll("[id]")];for(let t=0;t<e.length;t++)e[t].part.add(e[t].id);let i=[...this.shadowRoot.querySelectorAll("[class]")];for(let t=0;t<i.length;t++)i[t].part.add(...i[t].classList)}#e(e){return{currentUpdate:e,color:this.findElement("color").value,isFinished:this.findElement("is-finished").checked,description:this.findElement("description").textContent}}static create(e){let i=document.createElement(s);if(e==null)return i;for(let[t,n]of Object.entries(e))if(t=="value"||t=="placeholder"||t=="color")i.setAttribute(t,n);else if(t.startsWith("on")){let a=t.substring(2).toLowerCase();i.addEventListener(a,n)}return i}static observedAttributes=["value","description","color","is-finished"];attributeChangedCallback(e,i,t){e=="value"||e=="description"?this.findElement("description").textContent=t:e=="is-finished"?this.findElement("is-finished").checked=t=="true":e=="color"&&(this.findElement("color").value=t)}};customElements.get(s)==null&&customElements.define(s,r);export{s as COMPONENT_TAG_NAME,r as TaskCardElement,p as TaskCardEvent,u as TaskCardPart};
